			...
			<div class="row">
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						ArrayList<Bbs_hDTO> list = bbs.getCategoryList(pageNumber, "cafe");
						
						int numbering = 0;
						for (int i = 0; i < list.size(); i++) {
							int count = bbs.listofcategoryCount("cafe");
							if(pageNumber != 1){
				...
				if(pageNumber != 1) {
				%>
				<a href="bbs_cafe.jsp?pageNumber=<%= pageNumber - 1 %>" class="btn btn-light">이전</a>
				<%
				} if(bbs.nextPage(pageNumber + 1, "cafe")) {
				%>
				<a href="bbs_cafe.jsp?pageNumber=<%= pageNumber + 1 %>" class="btn btn-light">다음</a>
				<%
				}
				%> 				
				<br>
